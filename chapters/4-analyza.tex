...
V dnešní době existuje mnoho řešení, který využívají kontejnerizaci. V následující sekci porovnám vybraná řešení a zhodnotím jejich vhodnost použití v testovací knihovně. Hlavním požadavkem na dané řešení je, aby podporovalo operační systém Windows. Vybraná řešení tedy jsou: \customtodo{Dopsat levely kontejnerizačních řešení}
